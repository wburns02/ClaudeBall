...
const TradeMachinePage = lazy(() => import('@/pages/TradeMachinePage.tsx').then(m => ({ default: m.TradeMachinePage })));
const SeasonReviewPage = lazy(() => import('@/pages/SeasonReviewPage.tsx').then(m => ({ default: m.SeasonReviewPage })));
...
const DynastyOwnerPage = lazy(() => import('@/pages/dynasty/DynastyOwnerPage.tsx').then(m => ({ default: m.DynastyOwnerPage })));
const LivingDynastyPage = lazy(() => import('@/pages/dynasty/LivingDynastyPage.tsx').then(m => ({ default: m.LivingDynastyPage })));
    ...
    <FadeWrapper>
      <Suspense fallback={<PageFallback />}>
        <Routes>
          ...
          <Route path="/dynasty/owner" element={<FranchiseLayout><DynastyOwnerPage /></FranchiseLayout>} />
          <Route path="/dynasty/play" element={<MainLayout><LivingDynastyPage /></MainLayout>} />
          ...
          <Route path="/achievements" element={<MainLayout><AchievementsPage /></MainLayout>} />
          ...
          <Route path="/franchise/scoreboard" element={<FranchiseLayout><LeagueScoreboardPage /></FranchiseLayout>} />
          ...
          <Route path="/franchise/trade-machine" element={<FranchiseLayout><TradeMachinePage /></FranchiseLayout>} />
          <Route path="/franchise/season-review" element={<FranchiseLayout><SeasonReviewPage /></FranchiseLayout>} />
