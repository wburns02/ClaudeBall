  ...
  if (!season || !engine || !userTeamId) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center gap-4">
        <p className="font-display text-gold text-xl">Payroll</p>
        <p className="font-mono text-cream-dim text-sm text-center max-w-xs">Manage player contracts, budget allocation, and salary cap compliance.</p>
