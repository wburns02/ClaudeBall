  ...
  if (!season || !engine || !userTeamId) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center gap-4">
        <p className="font-display text-gold text-xl">Schedule</p>
        <p className="font-mono text-cream-dim text-sm text-center max-w-xs">View your full season schedule and simulate individual games.</p>
